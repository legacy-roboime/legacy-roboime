	...
	case 'r':
		{
			...
			robots->getRobotByIdByTeam(0, 0)->setGlobalPosition(NxVec3(3000, 0, 30));
			robots->getRobotByIdByTeam(0, 0)->putToSleep();

			robots->getRobotByIdByTeam(1, 0)->resetToInitialPose();
			robots->getRobotByIdByTeam(1, 0)->setGlobalPosition(NxVec3(2000, -1000, 30));
			...
			robots->getRobotByIdByTeam(3, 0)->setGlobalPosition(NxVec3(1000, -1000, 30));
			robots->getRobotByIdByTeam(3, 0)->putToSleep();

			robots->getRobotByIdByTeam(4, 0)->resetToInitialPose();
			robots->getRobotByIdByTeam(4, 0)->setGlobalPosition(NxVec3(1000, 1000, 30));
